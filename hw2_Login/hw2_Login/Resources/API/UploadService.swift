...
struct UploadService {
    ...
    func uploadImage(_ token: String, _ image: UIImage, _ imageName: String, completion: @escaping (NetworkResult<Any>) -> Void) {
        ...
        // mutipartFormData Encoding: UIImage형식을 jpegData로 바꿔줌
        // 0 ~ 1.0으로 사진 압축률을 정할 수 있다.
    ...
    private func judge(_ statusCode: Int, _ data: Data) -> NetworkResult<Any> { switch statusCode {
